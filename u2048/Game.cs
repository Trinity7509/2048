...
namespace u2048
{
    class Game
    {
        ...
        public void DrawGame(Graphics g)
        {
            ...
            DrawTextCenterWS(g, "T", fFontS2, new SolidBrush(Color.FromArgb(64, 10, 10, 10)), kTOP ? new SolidBrush(Color.FromArgb(247, 190, 48)) : new SolidBrush(Color.FromArgb(120, 110, 101)), 80, 46);
            DrawTextCenterWS(g, "D", fFontS2, new SolidBrush(Color.FromArgb(64, 10, 10, 10)), kBOTTOM ? new SolidBrush(Color.FromArgb(247, 190, 48)) : new SolidBrush(Color.FromArgb(120, 110, 101)), 80, 119);
            DrawTextCenterWS(g, "L", fFontS2, new SolidBrush(Color.FromArgb(64, 10, 10, 10)), kLEFT ? new SolidBrush(Color.FromArgb(247, 190, 48)) : new SolidBrush(Color.FromArgb(120, 110, 101)), 46, 83);
            DrawTextCenterWS(g, "R", fFontS2, new SolidBrush(Color.FromArgb(64, 10, 10, 10)), kRIGHT ? new SolidBrush(Color.FromArgb(247, 190, 48)) : new SolidBrush(Color.FromArgb(120, 110, 101)), 113, 83);
